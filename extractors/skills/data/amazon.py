...
SKILLS: list[Skill] = [
  ...
  MaybeSkill("Amazon-Athena", ["athena"], disambiguate=ctx),        # /
  Skill("Amazon-Aurora", ["(amazon=)aws=aurora", "amazon=aurora"]), # managed DB
  MaybeSkill("Amazon-Aurora", ["aurora"], disambiguate=ctx),        # /
  ...
  MaybeSkill("Amazon-Glue", ["glue"], disambiguate=ctx),      # /
  Skill("Amazon-IAM", ["(amazon=)aws=iam", "amazon=iam"]), # identity and access management
  MaybeSkill("Amazon-IAM", ["iam"], disambiguate=ctx),     # /
  Skill("Amazon-Lambda", ["(amazon=)aws=lambda", "amazon=lambda"]), # lambda
  MaybeSkill("Amazon-Lambda", ["lambda"], disambiguate=ctx),        # /
  ...
  MaybeSkill("Amazon-VPC", ["vpc"], disambiguate=ctx),     # /
