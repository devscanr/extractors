...
class Test_ExperienceExtractor:
  ...
  def test_extract_bios1(self, extract) -> None:
    assert extract("Senior fullstack developer") == [Experience("Senior")]
    ...
    assert extract("🍔💻| 1+ year of experience in software development") == [Experience("Exact", months=12, over=True)]
    assert extract("""
